...
function updateInvestmentValue(value) {
    document.getElementById("investment-value").innerText = `${parseFloat(value).toLocaleString('en-US')}`;
}
...
function calculateFD() {
    ...
    document.getElementById("invested-amount").innerText = `₦${principal.toLocaleString('en-US')}`;
    document.getElementById("estimated-returns").innerText = `₦${Math.round(interestEarned).toLocaleString('en-US')}`;
    document.getElementById("total-value").innerText = `₦${Math.round(totalAmount).toLocaleString('en-US')}`;
